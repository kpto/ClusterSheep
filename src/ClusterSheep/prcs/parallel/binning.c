...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "prcs.parallel.binning",
        "sources": [
            "prcs/parallel/binning.pyx"
        ]
    },
    "module_name": "prcs.parallel.binning"
}
END: Cython Metadata */
...
#define __PYX_HAVE__prcs__parallel__binning
#define __PYX_HAVE_API__prcs__parallel__binning
/* Early includes */
#include <string.h>
#include <stdio.h>
 ...
 */
typedef __pyx_t_5numpy_int32_t __pyx_t_4prcs_8parallel_7binning_RT_MZ_DATA_TYPE;

/* "prcs/parallel/binning.pyx":26
 * # ====BEGIN OF CONSTANT DEFINITION====
 * ctypedef np.int32_t RT_MZ_DATA_TYPE
 * ctypedef np.float32_t RT_INTENSITY_DATA_TYPE             # <<<<<<<<<<<<<<
 * # ====END OF CONSTANT DEFINITION====
 * 
 */
typedef __pyx_t_5numpy_float32_t __pyx_t_4prcs_8parallel_7binning_RT_INTENSITY_DATA_TYPE;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* ObjectToMemviewSlice.proto */
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_4prcs_8parallel_7binning_RT_MZ_DATA_TYPE(PyObject *, int writable_flag);

/* ObjectToMemviewSlice.proto */
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_4prcs_8parallel_7binning_RT_INTENSITY_DATA_TYPE(PyObject *, int writable_flag);
...
/* Module declarations from 'prcs.parallel.binning' */
...
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_4prcs_8parallel_7binning_RT_MZ_DATA_TYPE = { "RT_MZ_DATA_TYPE", NULL, sizeof(__pyx_t_4prcs_8parallel_7binning_RT_MZ_DATA_TYPE), { 0 }, 0, IS_UNSIGNED(__pyx_t_4prcs_8parallel_7binning_RT_MZ_DATA_TYPE) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_4prcs_8parallel_7binning_RT_MZ_DATA_TYPE), 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_4prcs_8parallel_7binning_RT_INTENSITY_DATA_TYPE = { "RT_INTENSITY_DATA_TYPE", NULL, sizeof(__pyx_t_4prcs_8parallel_7binning_RT_INTENSITY_DATA_TYPE), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "prcs.parallel.binning"
extern int __pyx_module_is_main_prcs__parallel__binning;
int __pyx_module_is_main_prcs__parallel__binning = 0;

/* Implementation of 'prcs.parallel.binning' */
...
static const char __pyx_k_mz_int[] = "mz_int";
static const char __pyx_k_name_2[] = "__name__";
static const char __pyx_k_new_mz[] = "new_mz";
static const char __pyx_k_pickle[] = "pickle";
static const char __pyx_k_reduce[] = "__reduce__";
static const char __pyx_k_struct[] = "struct";
static const char __pyx_k_unpack[] = "unpack";
static const char __pyx_k_update[] = "update";
static const char __pyx_k_binning[] = "_binning";
...
static const char __pyx_k_new_intensity[] = "new_intensity";
...
static const char __pyx_k_prcs_parallel_binning[] = "prcs.parallel.binning";
static const char __pyx_k_MemoryView_of_r_object[] = "<MemoryView of %r object>";
static const char __pyx_k_MemoryView_of_r_at_0x_x[] = "<MemoryView of %r at 0x%x>";
static const char __pyx_k_contiguous_and_indirect[] = "<contiguous and indirect>";
static const char __pyx_k_Cannot_index_with_type_s[] = "Cannot index with type '%s'";
static const char __pyx_k_Invalid_shape_in_axis_d_d[] = "Invalid shape in axis %d: %d.";
static const char __pyx_k_prcs_parallel_binning_pyx[] = "prcs/parallel/binning.pyx";
static const char __pyx_k_itemsize_0_for_cython_array[] = "itemsize <= 0 for cython.array";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_unable_to_allocate_array_data[] = "unable to allocate array data.";
static const char __pyx_k_Created_on_15_37_51_23_11_2017[] = "\nCreated on 15:37:51 23/11/2017\n\nAuthor: Paul TO, Ka Po\nContact: kpto@ust.hk\nInstitude: Hong Kong University of Science and Technology\nDepartment: Division of Biomedical Engineering\n\nSupervisor: Prof. Henry LAM, H. N.\nContact: kehlam@ust.hk\nInstitude: Hong Kong University of Science and Technology\nDepartment: Department of Chemical and Biomolecular Engineering\n\nDesciption of this module:\n";
...
static PyObject *__pyx_n_s_mz_int;
...
static PyObject *__pyx_n_s_prcs_parallel_binning;
static PyObject *__pyx_kp_s_prcs_parallel_binning_pyx;
...
static PyObject *__pyx_pf_4prcs_8parallel_7binning__binning(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_mz, __Pyx_memviewslice __pyx_v_intensity, __Pyx_memviewslice __pyx_v_new_mz, __Pyx_memviewslice __pyx_v_new_intensity); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_4prcs_8parallel_7binning_1_binning(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_4prcs_8parallel_7binning_1_binning = {"_binning", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4prcs_8parallel_7binning_1_binning, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_4prcs_8parallel_7binning_1_binning(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_mz = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_intensity = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_new_mz = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_new_intensity = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("_binning (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_mz,&__pyx_n_s_intensity,&__pyx_n_s_new_mz,&__pyx_n_s_new_intensity,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_intensity)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_binning", 1, 4, 4, 1); __PYX_ERR(0, 39, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_new_mz)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_binning", 1, 4, 4, 2); __PYX_ERR(0, 39, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_new_intensity)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_binning", 1, 4, 4, 3); __PYX_ERR(0, 39, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_binning") < 0)) __PYX_ERR(0, 39, __pyx_L3_error)
      }
    ...
    __pyx_v_mz = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float32_t(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_mz.memview)) __PYX_ERR(0, 39, __pyx_L3_error)
    __pyx_v_intensity = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float32_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_intensity.memview)) __PYX_ERR(0, 39, __pyx_L3_error)
    __pyx_v_new_mz = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_4prcs_8parallel_7binning_RT_MZ_DATA_TYPE(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_new_mz.memview)) __PYX_ERR(0, 40, __pyx_L3_error)
    __pyx_v_new_intensity = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_4prcs_8parallel_7binning_RT_INTENSITY_DATA_TYPE(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_new_intensity.memview)) __PYX_ERR(0, 40, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_binning", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 39, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("prcs.parallel.binning._binning", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4prcs_8parallel_7binning__binning(__pyx_self, __pyx_v_mz, __pyx_v_intensity, __pyx_v_new_mz, __pyx_v_new_intensity);
...
static PyObject *__pyx_pf_4prcs_8parallel_7binning__binning(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_mz, __Pyx_memviewslice __pyx_v_intensity, __Pyx_memviewslice __pyx_v_new_mz, __Pyx_memviewslice __pyx_v_new_intensity) {
 ...
 */
    __pyx_t_4 = __pyx_v_i;
    __pyx_t_5 = -1;
    if (unlikely(__pyx_t_4 >= (size_t)__pyx_v_mz.shape[0])) __pyx_t_5 = 0;
    if (unlikely(__pyx_t_5 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_5);
      __PYX_ERR(0, 50, __pyx_L1_error)
    }
    __pyx_v_mz_int = ((__pyx_t_4prcs_8parallel_7binning_RT_MZ_DATA_TYPE)(*((__pyx_t_5numpy_float32_t *) ( /* dim=0 */ (__pyx_v_mz.data + __pyx_t_4 * __pyx_v_mz.strides[0]) ))));
 ...
 *         else:
 */
    __pyx_t_6 = ((__pyx_v_mz_int == __pyx_v_previous) != 0);
    if (__pyx_t_6) {
 ...
 */
      __pyx_t_7 = __pyx_v_i;
      __pyx_t_5 = -1;
      if (unlikely(__pyx_t_7 >= (size_t)__pyx_v_intensity.shape[0])) __pyx_t_5 = 0;
      if (unlikely(__pyx_t_5 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_5);
      ...
      __pyx_t_5 = -1;
      if (unlikely(__pyx_t_8 >= (size_t)__pyx_v_new_intensity.shape[0])) __pyx_t_5 = 0;
      if (unlikely(__pyx_t_5 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_5);
        __PYX_ERR(0, 52, __pyx_L1_error)
      }
      *((__pyx_t_4prcs_8parallel_7binning_RT_INTENSITY_DATA_TYPE *) ( /* dim=0 */ (__pyx_v_new_intensity.data + __pyx_t_8 * __pyx_v_new_intensity.strides[0]) )) += (*((__pyx_t_5numpy_float32_t *) ( /* dim=0 */ (__pyx_v_intensity.data + __pyx_t_7 * __pyx_v_intensity.strides[0]) )));
 ...
 */
      ...
      __pyx_t_5 = -1;
      if (unlikely(__pyx_t_9 >= (size_t)__pyx_v_new_mz.shape[0])) __pyx_t_5 = 0;
      if (unlikely(__pyx_t_5 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_5);
        __PYX_ERR(0, 55, __pyx_L1_error)
      }
      *((__pyx_t_4prcs_8parallel_7binning_RT_MZ_DATA_TYPE *) ( /* dim=0 */ (__pyx_v_new_mz.data + __pyx_t_9 * __pyx_v_new_mz.strides[0]) )) = __pyx_v_mz_int;
 ...
 */
      ...
      __pyx_t_5 = -1;
      if (unlikely(__pyx_t_10 >= (size_t)__pyx_v_intensity.shape[0])) __pyx_t_5 = 0;
      if (unlikely(__pyx_t_5 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_5);
      ...
      __pyx_t_5 = -1;
      if (unlikely(__pyx_t_11 >= (size_t)__pyx_v_new_intensity.shape[0])) __pyx_t_5 = 0;
      if (unlikely(__pyx_t_5 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_5);
        __PYX_ERR(0, 56, __pyx_L1_error)
      }
      *((__pyx_t_4prcs_8parallel_7binning_RT_INTENSITY_DATA_TYPE *) ( /* dim=0 */ (__pyx_v_new_intensity.data + __pyx_t_11 * __pyx_v_new_intensity.strides[0]) )) = (*((__pyx_t_5numpy_float32_t *) ( /* dim=0 */ (__pyx_v_intensity.data + __pyx_t_10 * __pyx_v_intensity.strides[0]) )));
    }
    __pyx_L5:;
  }
 ...
 */
  ...
  __pyx_t_12 = __Pyx_PyInt_From_npy_uint32(__pyx_v_new_length); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 58, __pyx_L1_error)
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_new_mz, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_new_intensity, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "prcs.parallel.binning.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "prcs.parallel.binning.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "prcs.parallel.binning.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "prcs.parallel.binning._memoryviewslice", /*tp_name*/
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "binning",
    __pyx_k_Created_on_15_37_51_23_11_2017, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_mz_int, __pyx_k_mz_int, sizeof(__pyx_k_mz_int), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_prcs_parallel_binning, __pyx_k_prcs_parallel_binning, sizeof(__pyx_k_prcs_parallel_binning), 0, 0, 1, 1},
  {&__pyx_kp_s_prcs_parallel_binning_pyx, __pyx_k_prcs_parallel_binning_pyx, sizeof(__pyx_k_prcs_parallel_binning_pyx), 0, 0, 1, 0},
 ...
 * 
 */
  __pyx_tuple__26 = PyTuple_Pack(10, __pyx_n_s_mz, __pyx_n_s_intensity, __pyx_n_s_new_mz, __pyx_n_s_new_intensity, __pyx_n_s_previous, __pyx_n_s_mz_int, __pyx_n_s_cursor, __pyx_n_s_new_length, __pyx_n_s_length, __pyx_n_s_i); if (unlikely(!__pyx_tuple__26)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__26);
  __Pyx_GIVEREF(__pyx_tuple__26);
  __pyx_codeobj__27 = (PyObject*)__Pyx_PyCode_New(4, 0, 10, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__26, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_prcs_parallel_binning_pyx, __pyx_n_s_binning, 39, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__27)) __PYX_ERR(0, 39, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("binning", __pyx_methods, __pyx_k_Created_on_15_37_51_23_11_2017, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_prcs__parallel__binning) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "prcs.parallel.binning")) {
      if (unlikely(PyDict_SetItemString(modules, "prcs.parallel.binning", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4prcs_8parallel_7binning_1_binning, NULL, __pyx_n_s_prcs_parallel_binning); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * # ====CODE FOR MODULE TEST====
 */
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_name_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 63, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init prcs.parallel.binning", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init prcs.parallel.binning");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
/* ObjectToMemviewSlice */
  static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_4prcs_8parallel_7binning_RT_MZ_DATA_TYPE(PyObject *obj, int writable_flag) {
    __Pyx_memviewslice result = { 0, 0, { 0 }, { 0 }, { 0 } };
    __Pyx_BufFmt_StackElem stack[1];
    int axes_specs[] = { (__Pyx_MEMVIEW_DIRECT | __Pyx_MEMVIEW_STRIDED) };
    int retcode;
    ...
    retcode = __Pyx_ValidateAndInit_memviewslice(axes_specs, 0,
                                                 PyBUF_RECORDS_RO | writable_flag, 1,
                                                 &__Pyx_TypeInfo_nn___pyx_t_4prcs_8parallel_7binning_RT_MZ_DATA_TYPE, stack,
                                                 &result, obj);
    if (unlikely(retcode == -1))
        goto __pyx_fail;
    return result;
...
/* ObjectToMemviewSlice */
  static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_4prcs_8parallel_7binning_RT_INTENSITY_DATA_TYPE(PyObject *obj, int writable_flag) {
    __Pyx_memviewslice result = { 0, 0, { 0 }, { 0 }, { 0 } };
    __Pyx_BufFmt_StackElem stack[1];
    int axes_specs[] = { (__Pyx_MEMVIEW_DIRECT | __Pyx_MEMVIEW_STRIDED) };
    int retcode;
    ...
    retcode = __Pyx_ValidateAndInit_memviewslice(axes_specs, 0,
                                                 PyBUF_RECORDS_RO | writable_flag, 1,
                                                 &__Pyx_TypeInfo_nn___pyx_t_4prcs_8parallel_7binning_RT_INTENSITY_DATA_TYPE, stack,
                                                 &result, obj);
    if (unlikely(retcode == -1))
        goto __pyx_fail;
    return result;
