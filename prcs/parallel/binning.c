...
/* ObjectToMemviewSlice.proto */
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_4prcs_8parallel_7binning_RT_MZ_DATA_TYPE(PyObject *);

/* ObjectToMemviewSlice.proto */
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_4prcs_8parallel_7binning_RT_INTENSITY_DATA_TYPE(PyObject *);
...
static PyMethodDef __pyx_mdef_4prcs_8parallel_7binning_1_binning = {"_binning", (PyCFunction)__pyx_pw_4prcs_8parallel_7binning_1_binning, METH_VARARGS|METH_KEYWORDS, 0};
  ...
  __Pyx_RefNannySetupContext("_binning (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_new_mz)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_binning", 1, 4, 4, 2); __PYX_ERR(0, 39, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_new_intensity)) != 0)) kw_args--;
        else {
    ...
    __pyx_v_mz = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float32_t(values[0]); if (unlikely(!__pyx_v_mz.memview)) __PYX_ERR(0, 39, __pyx_L3_error)
    __pyx_v_intensity = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float32_t(values[1]); if (unlikely(!__pyx_v_intensity.memview)) __PYX_ERR(0, 39, __pyx_L3_error)
    __pyx_v_new_mz = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_4prcs_8parallel_7binning_RT_MZ_DATA_TYPE(values[2]); if (unlikely(!__pyx_v_new_mz.memview)) __PYX_ERR(0, 40, __pyx_L3_error)
    __pyx_v_new_intensity = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_4prcs_8parallel_7binning_RT_INTENSITY_DATA_TYPE(values[3]); if (unlikely(!__pyx_v_new_intensity.memview)) __PYX_ERR(0, 40, __pyx_L3_error)
  }
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initbinning(void); /*proto*/
PyMODINIT_FUNC initbinning(void)
#else
PyMODINIT_FUNC PyInit_binning(void); /*proto*/
PyMODINIT_FUNC PyInit_binning(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_binning(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_binning(void)", 0);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init prcs.parallel.binning", 0, __pyx_lineno, __pyx_filename);
    }
...
/* ObjectToMemviewSlice */
      static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_4prcs_8parallel_7binning_RT_MZ_DATA_TYPE(PyObject *obj) {
    __Pyx_memviewslice result = { 0, 0, { 0 }, { 0 }, { 0 } };
    __Pyx_BufFmt_StackElem stack[1];
    int axes_specs[] = { (__Pyx_MEMVIEW_DIRECT | __Pyx_MEMVIEW_STRIDED) };
    int retcode;
...
/* ObjectToMemviewSlice */
      static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_4prcs_8parallel_7binning_RT_INTENSITY_DATA_TYPE(PyObject *obj) {
    __Pyx_memviewslice result = { 0, 0, { 0 }, { 0 }, { 0 } };
    __Pyx_BufFmt_StackElem stack[1];
    int axes_specs[] = { (__Pyx_MEMVIEW_DIRECT | __Pyx_MEMVIEW_STRIDED) };
    int retcode;
